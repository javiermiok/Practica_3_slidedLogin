...
public class Controlador {
	...
	public void initialize() {
		...
		/*pane1.setStyle("-fx-background-image: url('application/sample1.jpg')");
		pane2.setStyle("-fx-background-image: url('application/sample2.jpg')");
		pane3.setStyle("-fx-background-image: url('application/sample3.jpg')");
		pane4.setStyle("-fx-background-image: url('application/sample4.jpg')");*/
